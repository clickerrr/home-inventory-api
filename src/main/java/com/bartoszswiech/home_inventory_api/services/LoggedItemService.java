...
public class LoggedItemService {
    ...
    @Transactional
    public LoggedItem  createLoggedItem(LoggedItem newLoggedItem, String upca, Long locationId, Long inventoryId) throws UserNotFoundException {
        ...
        // check if the currently authed user is even allowed to touch this house
        houseService.checkIfCurrentUserInHouse(inventory.getAssociatedHouse());
        ...
        location.addLoggedItem(newLoggedItem);
        System.out.println(String.format("Found inventory: %s",inventory));
        inventory.addLoggedItem(newLoggedItem);
